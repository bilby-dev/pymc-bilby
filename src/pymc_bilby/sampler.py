...
from bilby.core.prior import Cosine, DeltaFunction, MultivariateGaussian, PowerLaw, Sine
from bilby.core.utils import derivatives, infer_args_from_method
from bilby.core.sampler.base_sampler import MCMCSampler, signal_wrapper
    ...
    def _translate_kwargs(self, kwargs):
        ...
        if "cores" not in kwargs:
            for equiv in self.npool_equiv_kwargs:
                if equiv in kwargs:
                    kwargs["cores"] = kwargs.pop(equiv)
            if "cores" not in kwargs:
                kwargs["cores"] = self._npool
